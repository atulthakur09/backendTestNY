...
const vehicleService = require("../service-management/vehicle-service-estimation-jobcard-model")

const vehicleServiceEstimationValidationSchema = checkSchema({
    username: {
        exists: {
...
module.exports = vehicleServiceEstimationValidationSchema;
