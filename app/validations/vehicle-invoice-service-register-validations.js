...
const vehicleFinalInvoiceService = require("../models/vehicle-final-invoice-service-register-model");
const { chassisNumber, dateOfRCReg } = require('./vehicle-register-validations');

const vehicleFinalInvoiceServiceValidationSchema = checkSchema({
    username: {
        exists: {
...
module.exports = vehicleFinalInvoiceServiceValidationSchema;
