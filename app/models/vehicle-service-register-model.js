...
const vehicleServiceRegisterSchema = new Schema(
  {
    ...
    //invoice number generated at the time of appointment booking
    quotationNo: { type: String, default: "" },
    bookingId: { type: String, default: "" },

    // service Management
    // vehicle Recived
    vehicleInOut: { type: String, enum: ["OUT", "IN", "N/A"], default: "N/A" },
    ...
    dealerDismantlingReq: {
      type: String,
      enum: ["N/A", "Required", "Not Required"],
      default: "N/A",
    },
    dismantaleApprovalByDealer: {
      type: String,
      enum: ["Require", "Not Require"],
      default: "Not Require",
    },
    ...
    partsOrdered: {
      type: String,
      enum: ["N/A", "Ordered", "In Transit", "Order Recieved"],
      default: "N/A",
    },
    ...
    preInvoice: {
      type: String,
      enum: ["Invoice Generated", "Invoice Rejected", "N/A"],
      default: "N/A",
    },
    ...
    preInvoiceStatus: {
      type: String,
      enum: ["N/A", "Approved", "Rejected"],
      default: "N/A",
    },
    preInvoiceComment: { type: String, default: "N/A" },

    // Final Invoice
    finalInvoiceApproval: {
      type: String,
      enum: ["N/A", "Approved", "Rejected", "Pending"],
      default: "N/A",
    },
    finalInvoice: {
      type: String,
