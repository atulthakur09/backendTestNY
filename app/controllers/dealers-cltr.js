...
//     const shopImagesResult = await uploadFileToCloudinary(files.shopImages[0], "shop-images");
//     const gstImagesResult = await uploadFileToCloudinary(files.gstImages[0], "gst-images");
//     const panCardResult = await uploadFileToCloudinary(files.panCard[0], "pan-cards");
//     const aadhaarCardResult = await uploadFileToCloudinary(files.aadhaarCard[0], "aadhaar-cards");
...
//     await fs.promises.unlink(shopImagesResult.localPath);
//     await fs.promises.unlink(gstImagesResult.localPath);
//     await fs.promises.unlink(panCardResult.localPath);
//     await fs.promises.unlink(aadhaarCardResult.localPath);

//     // Return success response with the created partner ID
//     res.status(201).json(newPartner);
//   } catch (err) {
